                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="phn_no" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div>
                            <button class="btn btn--radius-2 bg-gra-03" name="btn" type="submit">Register</button>
                        </div>
                    </form>
                    <a href="index.php" class="btn btn--radius-2 btn--red"">Cancel</a>
                </div>
            </div>
        </div>
    </div>
