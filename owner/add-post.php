        ...
        <?php }?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2 class="text-center bg-deep-orange" style="padding: 10px;">Add Blog Post Info</h2>
                        </div>
                        <div class="body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="details" cols="30" rows="5" class="form-control no-resize" ></textarea>
